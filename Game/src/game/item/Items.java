...
public class Items {
	...
	public static Item meat_pig_raw = new ItemFood("meat_pig_raw", "Raw Pig Meat", 0.5F).setTexture(Images.loadImage("/items/meat_pig.png")).setCookable();
	public static Item meat_pig = new ItemFood("meat_pig_cooked","Pig Meat", 1.5f).setTexture(Images.loadImage("/items/meat_pig_cooked.png"));
